...
import com.car.loader.map.DriveRoutePlan;
import com.car.loader.map.DrivingRouteOverlay;
import com.car.loader.map.NowPlaceActivity;
import com.car.loader.map.OverlayManager;
import com.car.loader.map.ShowRouteDetilsActivity;
...
public class PetrolDriveRoutePlan extends Activity
		implements OnClickListener, OnGetGeoCoderResultListener, OnGetRoutePlanResultListener , BaiduMap.OnMapClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PlanNode startNode = PlanNode.withLocation(locLatLng);
		PlanNode endNode = PlanNode.withLocation(desLatLng);
	...
	public void onGetDrivingRouteResult(DrivingRouteResult result) {
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(PetrolDriveRoutePlan.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
		}
	...
	public void nodeClick(View v) {
		...
		// show popup
		popupText = new TextView(PetrolDriveRoutePlan.this);
