...
/**
 * 用于显示驾车路线的overlay，自3.4.0版本起可实例化多个添加在地图中显示，当数据中包含路况数据时，则默认使用路况纹理分段绘
 */
public class DrivingRouteOverlay extends OverlayManager {
    ...
    public final List<OverlayOptions> getOverlayOptions() {
                                                    ...
                                                    .rotate( 360-step.getDirection())
                                                            .extraInfo(b)
                                                                    .icon(BitmapDescriptorFactory
                                                                            .fromAssetWithDpi("Icon_line_node.png")).visible(false));
                }
                // 后路段绘制出口点
        ...
        if (mRouteLine.getAllStep() != null
            ...
            PolylineOptions option = new PolylineOptions().points(points).customTexture(DrivingRouteOverlay.getCustomTexture()).textureIndex(traffics)
    ...
    public static BitmapDescriptor getCustomTexture(){
