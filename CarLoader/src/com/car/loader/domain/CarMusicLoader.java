...
public class CarMusicLoader {
	...
	private static CarMusicLoader musicLoader;
	...
	public static CarMusicLoader instance(ContentResolver pContentResolver){
		if(musicLoader == null){
			contentResolver = pContentResolver;
			musicLoader = new CarMusicLoader();			
		}
		return musicLoader;
	}
	
	private CarMusicLoader(){		
	...
	public static class MusicInfo implements Parcelable{										
		...
		public static final Parcelable.Creator<MusicInfo> 
			CREATOR = new Creator<CarMusicLoader.MusicInfo>() {
